    ...
    return (
        <>
           <div className='' style={{background: 'pink', height: '15vh', display: 'flex', alignItems:'center', justifyContent: 'center', width: '100vw', overflow: 'hidden'}}>
                ...
                {location.pathname !== '/signup' && location.pathname !== '/' && <Link to="/logout" className='navbarlinks'>Logout <IoMdLogOut style={{display: 'inlineFlex', alignItems: 'center'}} size={'22px'} /></Link>}
            </div>
        </>
    )
}